                        ...
                        <td class="px-6 py-4 text-right">
                            @if($borrow->status == 'pending')
                                <div class="flex items-center justify-end gap-2">
                                    <form action="{{ route('staff.borrows.approve', $borrow->id) }}" method="POST" onsubmit="return confirm('Setujui peminjaman ini?');">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <form action="{{ route('staff.borrows.reject', $borrow->id) }}" method="POST" onsubmit="return confirm('Tolak pengajuan peminjaman ini?');">
                                        @csrf
                                        @method('DELETE')
