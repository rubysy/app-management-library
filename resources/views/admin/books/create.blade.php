    ...
    <div class="max-w-4xl mx-auto bg-white border border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] overflow-hidden">
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                ...
                <div class="col-span-2">
                    ...
                    <div class="border border-black p-4 max-h-48 overflow-y-auto">
                        ...
                        @if($categories->isEmpty())
                            <p class="text-gray-500 text-sm text-center py-2">Belum ada kategori. <a href="{{ route('categories.create') }}" class="text-[#FF3B30] font-bold">Buat kategori dulu.</a></p>
                        @endif
                    </div>
            ...
            <div class="mt-8 flex justify-end space-x-3">
                <a href="{{ route('books.index') }}" class="px-6 py-2 border border-black text-black font-bold hover:bg-gray-100 transition-colors">
                    Batal
                </a>
